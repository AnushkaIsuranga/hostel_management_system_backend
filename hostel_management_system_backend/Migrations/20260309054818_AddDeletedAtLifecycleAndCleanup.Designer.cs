...
namespace hostel_management_system_backend.Migrations
{
    ...
    [Migration("20260309054818_AddDeletedAtLifecycleAndCleanup")]
    partial class AddDeletedAtLifecycleAndCleanup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("DistanceWeight")
                        .HasColumnType("float");
                    ...
                    b.Property<string>("PriorityOrderJson")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<string>("SelectedAmenitiesJson")
                        .IsRequired()
                        .HasMaxLength(4000)
            ...
            modelBuilder.Entity("StudentPreference", b =>
                {
                    ...
                    b.HasOne("User", "User")
                        ...
                        .HasForeignKey("StudentPreference", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
